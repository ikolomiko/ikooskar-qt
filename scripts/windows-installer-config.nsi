...
WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\ikoOSKAR" "DisplayName" "ikoOSKAR v4"
WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\ikoOSKAR" "DisplayVersion" "v4"
